<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-6">
        ...
        <a href="<?php echo base_url('uangKas/tambah') ?>" class="btn btn-sm btn-info float-right"><i class="fas fa-plus">
            Tambah Bulan</i></a>
    </div>            
...
<div class="col-md-4 col-xl-4 mb-4 align-items-center">
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-4">
                    ...
                    <div class="float-left">
                        <a  class="btn btn-sm btn-info" href="<?php echo base_url('uangKas/detail/'.$bln['id_bulan']) ?>"><i class="fas fa-bars"></i></a>
                        <a onclick="return confirm('Yakin hapus?')" class="btn btn-sm btn-danger" href="<?php echo base_url('uangKas/hapus/'.$bln['id_bulan']) ?>"><i class="fas fa-trash"></i></a>
                    </div>
                </div>
            </div>
        </div>
