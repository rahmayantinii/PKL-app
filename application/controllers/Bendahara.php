...
class Bendahara extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('templates/sidebarBendahara', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('bendahara/dashboard/index', $data);
	...
	public function indexUang()
	{
		...
		$this->load->view('templates/sidebarBendahara', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('bendahara/uangKas/index', $data);
		$this->load->view('templates/footer');
	}
	...
	public function detail($id)
	{
		...
		$this->load->view('templates/sidebarBendahara', $data);
		$this->load->view('templates/topbar', $data);
		$this->load->view('bendahara/uangKas/detail', $data);
		$this->load->view('templates/footer');
